...
const CONTENT_TYPES = [
  ...
  { label: "🎬  Konten Edukasi", value: "Konten Edukasi" },
  { label: "💰  Konten Monetisasi", value: "Konten Monetisasi" },
  { label: "🎙️  Podcast / Audio", value: "Podcast/Audio" },
  { label: "🤔  Bantu saya temukan niche saya", value: "Niche Finder" },
];
